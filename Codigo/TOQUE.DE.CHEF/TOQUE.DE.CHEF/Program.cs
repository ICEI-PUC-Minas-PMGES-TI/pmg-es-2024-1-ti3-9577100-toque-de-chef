...
builder.Services.AddDbContext<Context>(options =>
    options.UseSqlServer("Data Source=localhost,1433;Initial Catalog=DB_TOQUE_DE_CHEF;Integrated Security=false;User ID=sa;Password=Pedrozix1v9;Connect Timeout=15;Encrypt=false;TrustServerCertificate=false"));
